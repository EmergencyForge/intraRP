...
<body data-bs-theme="dark" data-page="mitarbeiter">
        ...
        <div class="modal fade" id="editDienstgradModal" tabindex="-1" aria-labelledby="editDienstgradModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= BASE_PATH ?>admin/personal/management/dienstgrade/update.php" method="POST">
                    ...
                    <form id="delete-dienstgrad-form" action="<?= BASE_PATH ?>admin/personal/management/dienstgrade/delete.php" method="POST" style="display:none;">
    ...
    <?php if (Permissions::check('admin')) : ?>
        <div class="modal fade" id="createDienstgradModal" tabindex="-1" aria-labelledby="createDienstgradModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= BASE_PATH ?>admin/personal/management/dienstgrade/create.php" method="POST">
                        <div class="modal-header">
