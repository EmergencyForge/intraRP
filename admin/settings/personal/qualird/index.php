...
<body data-bs-theme="dark" data-page="settings">
        ...
        <div class="modal fade" id="editDienstgradModal" tabindex="-1" aria-labelledby="editDienstgradModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= BASE_PATH ?>admin/settings/personal/qualird/update.php" method="POST">
                    ...
                    <form id="delete-dienstgrad-form" action="<?= BASE_PATH ?>admin/settings/personal/qualird/delete.php" method="POST" style="display:none;">
    ...
    <?php if (Permissions::check('admin')) : ?>
        <div class="modal fade" id="createDienstgradModal" tabindex="-1" aria-labelledby="createDienstgradModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= BASE_PATH ?>admin/settings/personal/qualird/create.php" method="POST">
                        <div class="modal-header">
